...
# scraping 2020 Rb fantasy stats
url = requests.get('https://www.fantasypros.com/nfl/stats/rb.php?year=2020')
src = url.content
...
# export to csv
final_2020_df.to_csv(r"RbStats2020.csv", 
...
# scraping 2018
url = requests.get('https://www.fantasypros.com/nfl/stats/rb.php?year=2018')
src = url.content
soup = BeautifulSoup(src, 'html.parser')
...
# export to csv
final_2018_df.to_csv(r"RbStats2018.csv", 
                index = False, sep = ',', encoding = 'utf-8')


# scraping 2019
url = requests.get('https://www.fantasypros.com/nfl/stats/rb.php?year=2019')
src = url.content
soup = BeautifulSoup(src, 'html.parser')
...
# export to csv
final_2019_df.to_csv(r"RbStats2019.csv", 
                index = False, sep = ',', encoding = 'utf-8')